                  ...
                  ?>
                            <tr>
                                ...
                                <td class='project-actions text-center'>
                                    <button type="button" class="btn btn-default btn_edit" data-toggle="modal"
                                        data-target="#modal" id="btn_edit_<?php echo($row["cardID"]) ?>"
                                        data-CardID_Edit="<?php echo($row["cardID"]) ?>">
                                        <i class="fas fa-solid fa-pen-to-square"></i>Edit
                                    </button>
                                    <a class='btn btn-danger'
                                        href='Card-delete-action.php?cardID=<?php echo ($row["cardID"]) ?>&type=<?php echo ($row["type"]) ?>'>
