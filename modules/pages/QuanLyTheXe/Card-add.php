                      ...
                      <select id="selectStatus">
                        ...
                        <option value="0">Khóa</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="txtCustomerIdentityCard-Add"
                                                class="inputForMonthCard-Add" name="txtCustomerIdentityCard_Add"
                                                value="" />
                                            <p class="errorMessenge">Báo lỗi</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="txtPhoneNumber-Add">Số điện thoại</label>
                                            <input type="text" id="txtPhoneNumber-Add" class="inputForMonthCard-Add"
                                                name="txtPhoneNumber_Add" value="" />
                                            <p class="errorMessenge">Báo lỗi</p>
                                        </div>
                                        <div class="form-group">
