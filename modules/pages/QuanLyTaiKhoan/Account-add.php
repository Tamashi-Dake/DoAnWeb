                            ...
                            <div class="card card-primary" style="box-shadow:none; margin:0;">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="inputUser" class="form-control" value="#" />
                                        <p class="errorMessenge">Báo lỗi</p>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputPassword">Mật khẩu</label>
                                        <input type="text" id="inputPassword" class="form-control" value="#" />
                                        <p class="errorMessenge">Báo lỗi</p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="inputCCCD" class="form-control" value="#" />
                                        <p class="errorMessenge">Báo lỗi</p>
                                    </div>
                                    <div class="form-group">
